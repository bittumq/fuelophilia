...
import { aboutus } from "../../../config/constants";
    ...
    return (
        <>
            <header
                id="header"
                className="fixed-top "
                style={{ backgroundColor: "#3c475a" }}
            >
                <div className="container d-flex align-items-center">
                    <h1 className="logo me-auto">
                        <a href="index.html">Fuelophilia</a>
                    </h1>
                                        ...
                                        <li>
                                            ...
                                            >
                                                <p>
                                                    ...
                                                    consequat. Tempus iaculis
                                                    urna id volutpat lacus
                                                    laoreet non curabitur
                                                    gravida. Venenatis lectus
                                        ...
                                        <li>
                                            ...
                                            >
                                                <p>
                                                    ...
                                                    integer enim. Sem nulla
                                                    pharetra diam sit amet nisl
                                                    suscipit. Rutrum tellus
                                    ...
                                    <i classname="bx bxl-linkedin">
                                        <div classname="container footer-bottom clearfix">
                                            ...
                                            <div classname="credits">
                                                ...
                                                only if you purchased the pro
                                                version. */{"}"}
                                                {"{"}/* Licensing information:
                                                https://bootstrapmade.com/license/
                                                */{"}"}
                                                {"{"}/* Purchase the pro version
                                                with working PHP/AJAX contact
                                                form:
